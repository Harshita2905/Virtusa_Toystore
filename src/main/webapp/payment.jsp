        ...
        <div class="container-fluid">
            <div class="row banner-row">
                <div class="col-lg-8 bg-img text-center">
                    ...
                    <div style="width: 450px;height:500px; padding: 20px; background-color: #25E0FF; margin-left:200px; border-radius: 15px;">
                   
                        <div class="container">
                            <h2>Payment&#128179</h2>
                            <hr>
                            <form action="/payment" method="post">
                                <div class="form-group">
                                    <label for="bagtotal" style="font-size: 18px;">Bag total : <h2>${bagtotal1}</h2></label>
                                    
                                    <!-- <label for="bagtotal"class="form-control" id="bagtotal"  name="bagtotal" style="font-size: 14px; height: 40px;"></label> -->

                                </div>
                                <div class="form-group">
                                    <label for="UPI" style="font-size: 18px;">UPI :<h2>${upi}</h2></label>
                                   
                                    <%-- <label for="UPI"class="form-control" id="UPI" value = "${upi.UPI}" name="UPI" style="font-size: 14px; height: 40px;"></label> --%>

                                </div>
                                
                                <div class="form-group">
                                    <label for="pin" style="font-size: 18px;">Pin :</label>
                                    <input type="password" class="form-control" id="pin" placeholder="Enter pin" name="pin" style="font-size: 14px;" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="vcode" style="font-size: 18px;">OTP :</label>
                                    <input type="text" class="form-control" id="vcode" placeholder="Enter otp" name="vcode" style="font-size: 14px;" required>
                                </div>
                               
                                <button type="submit" class="btn btn-success" style="font-size: 19px;   border-radius: 7px;"onclick="return confirm('Click `OK` for payment confirmation')"> Pay </button>
                            </form>
                        </div>
                     </div>
                </div>
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div style="width: 450px;height:600px; padding: 20px; margin-top: 120px; margin-left: 5px; border-radius: 15px;">
                        ...
                        <div class="container">
                            <h5 class="agile-title">Thank you for shopping with us&#128150!!</h5>
                            <hr>
                                <img src="images/woody-buzz.gif" alt="" width="400px" height="500px">
                            </div>
