...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
            ...
            <div class="row banner-row">
                <div class="col-lg-8 bg-img text-center">
                    ...
                    <form action="/thankyou" method = "post"> 
                        <div class="container" style="margin-top: 180px;">
                            <h2>Payment Successful&#128077</h2>
                            
                            
                            <h4>click here to <button type="submit" class="btn btn-success">download</button> invoice</h4>
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div style="width: 450px;height:600px; padding: 20px; margin-top: 120px; margin-left: 5px; border-radius: 15px;">
                        ...
                        <div class="container">
                           <h4>Thank you!!&#129309 <a href="/placeorder">Explore more &#10024</a></h4>
                            <hr>
                                <img src="images/thankyou.gif" alt="" width="400px" height="300px">
                            </div>
    ...
    <footer class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <h2 class="agile-title"><a href="/index" class="text-capitalize" data-blast="color">ToyStory</a></h2>
                </div>
