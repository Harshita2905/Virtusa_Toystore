    ...
    <div id="home" class="banner" data-blast="bgColor">
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
            <div class="container">
                ...
                <div class="nav-item  position-relative">
                    ...
                    <div id="menu">
                        <ul>
                            <li><a data-blast="color" href="customer.jsp">Place Order</a></li>
                            <li><a data-blast="color" href="ViewBag.jsp">My bag</a></li>
                            <li><a data-blast="color" href="aboutus.jsp">About us</a></li>
                            <li><a data-blast="color" href="reviews.jsp">Reviews</a></li>
                            <li><a data-blast="color" href="index.jsp">Logout</a></li>
                        </ul>
                    </div>
       ...
       <div class="container-fluid">
                ...
                <div class="bg-img text-center">
                   <h3>&#128420 Customer Reviews &#128420</h3>
                   <hr>
