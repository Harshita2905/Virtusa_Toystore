        ...
        <div class="container-fluid">
            <div class="row banner-row">
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div style="width: 450px;height:500px; padding: 20px; background-color: white; margin-top: 100px; margin-left: 15px; border-radius: 15px;">

                   
                        <div class="container">
                            <h2>Add Product&#128221</h2>
                            <hr>
                            <form action="/addproduct" method="POST">
                               
                                <div class="form-group">
                                    <label for="productname" style="font-size: 18px;">Product Name :</label>
                                    <input type="text" class="form-control" id="productname" placeholder="Enter product Name" name="productname" style="font-size: 14px;">
                                </div>
                                <div class="form-group">
                                    <label for="producttype" style="font-size: 18px;">Product Type :</label>
                                    
                                    <select class="form-control" name="producttype" id="producttype" style="font-size: 16px; height: 35px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="productquantity" placeholder="Enter product Quantity" name="productquantity" style="font-size: 14px;">
                                </div>
                                <div class="form-group">
                                    <label for="productprice" style="font-size: 18px;">Product Price :</label>
                                    <input type="text" class="form-control" id="productprice" placeholder="Enter product Price" name="productprice" style="font-size: 14px;">
                                </div>
                                
                                
                                <button type="submit" class="btn btn-default" style="font-size: 19px; margin-left: 150px; background-color: #25E0FF; border-radius: 7px;" onclick="return confirm('You want to add Product?')">Submit</button>
                            </form>
                        </div>
                     </div>
