        ...
        <div class="container-fluid">
            <div class="row banner-row">
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div style="width: 450px;height:250px; padding: 20px; background-color: white; margin-top: 80px; margin-left: 15px; border-radius: 15px;">

                   
                        <div class="container">
                            <h2>Delete Product&#9940</h2>
                            <hr>
                            <form action="/deleteproduct" method ="post">
                                <div class="form-group">
                                    <label for="productid" style="font-size: 18px;">Product Id :</label>
                                    <input type="text" class="form-control" id="productid" placeholder="Enter product Id" name="productid" style="font-size: 14px;">
                                </div>
                                
                               
                                
                                <button type="submit" class="btn btn-default" style="font-size: 19px; margin-left: 150px; background-color: #25E0FF; border-radius: 7px;"onclick="return confirm('You want to delete Product?')">Submit</button>
                            </form>
                        </div>
                     </div>
