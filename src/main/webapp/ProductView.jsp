                    ...
                    <div class="bg-img text-center">
                       ...
                       <table>
                        ...
                        <tr>
                            ...
                            <td><form method="post" action="/deleterow/${element.productid}">
                            ...
                            <td>
                            <%-- <form method="post" action="/updateproduct/${element.productid}"> --%>

                            <a href = "/updateproduct" style="border: none; font-size: 25px;"> &#128203
                            </a>
                            </td>
