...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
            <div class="container">
                ...
                <h1 class="wthree-logo">
                    <a href="customer.jsp" id="logoLink" data-blast="color">ToyStory</a>
                </h1>
        ...
        <div class="container-fluid">
            <div class="row banner-row">
                <div class="col-lg-8 bg-img text-center">
                   <h3>&#128420Trending Today&#128420</h3>
                   <hr>
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div style="width: 450px;height:600px; padding: 20px; margin-top: 120px; margin-left: 15px; border-radius: 15px;">
                        <!-- <button>submit</button> -->
                   
                        <div class="container">
                            <h6 class="agile-title">Explore new Magical Adventures!!</h6>
                            <h2>Welcome Customer &#129321</h2>
                            <hr>
                            <form action="/placeorder"  method ="post">
                               
                                <div class="form-group">
                                    <label for="producttype" style="font-size: 20px;">Place Order</label>
                                    <div class="form-group">
                                        <label for="productid" style="font-size: 18px;">Product Id :</label>
                                        <input type="number" class="form-control" id="productid" placeholder="Enter product Id" name="productid" style="font-size: 14px;">
                                    </div>
                                
                                   
                                <div class="form-group">
                                    <label for="productquantity" style="font-size: 18px;">Product Quantity :</label>
                                    <input type="number" class="form-control" id="productquantity" placeholder="Enter product Quantity" name="quantity" style="font-size: 14px;">
                                </div>
                            </div>
                                
                                
                                <br>
                                <button type="submit" class="btn btn-default" style="font-size: 18px; margin-left: 40px; background-color: white; border-radius: 7px;" onclick="return confirm('You want to add Product to bag?')">Add to bag&#128092</button>

                                <a href = "/viewbag"class="btn btn-default" style="font-size: 18px; margin-left: 10px; background-color: white; border-radius: 7px; color: black;">View bag&#128092</a>
    ...
    <footer class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <h2 class="agile-title"><a href="customer.jsp" class="text-capitalize" data-blast="color">ToyStory</a></h2>
                </div>
