        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
            <div class="container">
                <h1 class="wthree-logo">
                    <a href="/admin" id="logoLink" data-blast="color">ToyStory</a>
                </h1>
        ...
        <div class="container-fluid">
            <div class="row banner-row">
                ...
                <div class="col-lg-4  my-auto p-0">
                    ...
                    <div style="width: 450px;height:600px; padding: 20px; margin-top: 250px; margin-left: 15px; border-radius: 15px;">

                   
                        <div class="container">
                            <h2>Welcome Admin &#128525</h2>
                            <hr>
                            <label for="amount" style="font-size: 25px; font-weight:bold">Total Amount :&emsp;&emsp;<span style="font-size:25px">${amount}</span></label>
                            
                            <form action="selected" method ="post">
                               
                                <div class="form-group">
                                    <label for="producttype" style="font-size: 18px;">What you want to do :</label>
                                    
                                    <select class="form-control" name="selected" id="selected" style="font-size: 16px; height: 35px;">
                                        <option value="type">Select type</option>
                                        <option value="add">Add product</option>
                                        <option value="delete">Delete product</option>
                                       <option value="update">Update product</option>
                                        <option value="view">View all products</option>
                                        <option value="viewfeedback">Feedbacks</option>
                                ...
                                <button type="submit" class="btn btn-default" style="font-size: 18px; margin-left: 150px; background-color: white; border-radius: 7px;">Submit</button>
                            </form>
                        </div>
                     </div>
